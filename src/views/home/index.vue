<template>
	<div>
		<dv-border-box-12 class="box1 box3" style="left: 0; right: auto; height: 30%">
			<div class="box1-title">
				<div class="d-flex">
					<span class="text px-4">农场介绍</span>
				</div>
			</div>
		...
		<dv-border-box-12 class="box1 box3" style="left: 0; right: auto; top: 440px">
			<div class="box1-content">
				<div class="d-flex">
				</div>
			</div>
			<div class="p-3">
				<marquee direction="up" width="100%" height="180px" scrollamount="1" scrolldelay="1" behaviou="Scroll"
					align="Middle">
					...
					<p style="text-indent: 2em;">
						海南科技职业大学信息工程学院智慧农业项目团队致力于推动农业领域的数字化和智能化发展，通过整合先进的信息技术、物联网、大数据和人工智能等技术，为农业生产提供高效、智能的解决方案。</p>
				</marquee><!--  -->
			</div>
		</dv-border-box-12>
		<dv-border-box-12 class="box1 box3" style="left: 0; top: 670px; height: 37%">
			<div class="box1-title">
				<div class="d-flex">
		...
		<dv-border-box-12 class="box2 box4" style="height: 39%">
			<div class="box1-title">
				<div class="d-flex">
		...
		<dv-border-box-12 class="box2 box5" style="height: 45%;">
			<div class="box1-title">
				<div class="d-flex">
...
export default {
	components: { centerLeft1, centerRight2, center, CenterChart },
	props: {},
	data() {
		return {
			ranking: {
			...
			imgs: [
				...
				require('./../../assets/image/pic17.jpg'),
				require('./../../assets/image/pic18.jpg'),
				require('./../../assets/image/pic19.jpg'),
			],
		};
	},
};
