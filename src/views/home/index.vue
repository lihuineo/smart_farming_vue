<template>
	<div>
		<dv-border-box-12
			class="box1 box3"
			style="left: 0; right: auto; height: 30%"
		>
		...
		<dv-border-box-12
			class="box1 box3"
			style="left: 0; right: auto; top: 440px"
		>
		...
		<dv-border-box-12
			class="box1 box3"
			style="left: 0; top: 670px; height: 37%"
		>
			<div class="box1-title">
				<div class="d-flex">
		...
		<dv-border-box-12
			class="box1 box3"
			style="right: auto; height: 220px; width: 30%; left: 30%; top: 10%"
		>
			<div class="box1-title" style="background-size: 100% 100%">
				<div class="d-flex">
					<span class="text px-4">种植种类</span>
				</div>
			</div>
		...
		<dv-border-box-12
			class="box1 box3"
			style="right: auto; height: 220px; width: 30%; left: 30%; top: 30%"
		>
			<div class="box1-title" style="background-size: 100% 100%">
				<div class="d-flex">
					<span class="text px-4">种植分布</span>
				</div>
			</div>
			<div class="p-3" style="height: calc(100% - 40px); display: flex">
				<div style="width: 50%">
		...
		<dv-border-box-12
			class="box1 box3"
			style="right: auto; height: 220px; width: 30%; left: 30%; top: 50%"
		>
			<div class="box1-title" style="background-size: 100% 100%">
				<div class="d-flex">
					<span class="text px-4">告警列表</span>
				</div>
			</div>
			<div
				class="p-1"
